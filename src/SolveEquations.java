...
public class SolveEquations {
    public static void main(String[] args) {
        String[] options = {"Linear Eq (1 var)", "Linear System (2 vars)", "Quadratic Eq"};
    ...
    private static void solveLinearEquation() {
        ...
        double b = Double.parseDouble(JOptionPane.showInputDialog("Enter b (ax + b = 0):"));
    ...
    private static void solveLinearSystem() {
        ...
        if (D != 0) {
            double x1 = D1 / D;
            double x2 = D2 / D;
            JOptionPane.showMessageDialog(null, "Solutions: x1 = " + x1 + ", x2 = " + x2);
        } else {
            if (D1 == 0 && D2 == 0) {
    ...
    private static void solveQuadraticEquation() {
        double a = Double.parseDouble(JOptionPane.showInputDialog("Enter a (ax^2 + bx + c = 0):"));
        ...
        if (a == 0) {
            if (b == 0) {
                ...
                JOptionPane.showMessageDialog(null, "Linear result: x = " + (-c / b));
            }
        } else {
